import type { Call, EndpointString, GraphqlMethods, Catalog, RequestComponents } from "@/types.ts";
...
import type { RequestResolver, ResponseResolver } from "@/connectors/types.ts";
